...
from logging import (INFO, FileHandler, StreamHandler, basicConfig, error, getLogger, info, warning, Formatter)
from os import environ, path as ospath, remove as osremove, getcwd
